...
Статус: фазы 0-13, 17 и 19 сделаны. Активная работа - фазы 14-15 и 18 дорожной карты v2, по
каждой есть пошаговая инструкция `PLAN-FAZA-*.md` (см. таблицу ниже). Фаза 16 отложена до
решения владельца.
...
| 14. Оркестратор жизненного цикла задачи | не начата | [PLAN-FAZA-14.md](PLAN-FAZA-14.md) |
| 15. Очередь задач и параллельность | не начата | [PLAN-FAZA-15.md](PLAN-FAZA-15.md) |
...
выполнения: 14 → 15 (16 отложена, 18 независима и может идти в любой момент).
...
Статус: не начата (зависит от фаз 11-13; 11 и 12 закрыты, ждёт 13).
...
**Фаза 15. Очередь задач и параллельность (2-3 дня).** Статус: не начата (зависит от фазы 11,
закрыта).
