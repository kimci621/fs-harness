...
Статус: фазы 0-10 и 17 сделаны, идёт дорожная карта v2 (фазы 11-19).
...
- Демон опроса: `fsh watch --daemon`, интервал `watch.intervalSeconds` (дефолт 60 с), вкл/выкл и
  интервал на проект.
...
4. Комментарии и worklog в Jira - слой read-only. *Изменено по решению владельца 2026-09-11 и
   ...
   Своего редактора текста в TUI по-прежнему нет (см. п. 16). Не наши остаются worklog и вложения. Переходы с обязательными полями
